...
# CSV einlesen
df = pd.read_csv("persona_bias_optimized3.csv")
...
plt.ylabel("Anzahl")
plt.savefig("plots3/toxicity_distribution.png")
plt.close()
...
plt.ylabel("Anzahl")
plt.savefig("plots3/sentiment_per_topic.png")
plt.close()
...
plt.savefig("plots3/toxicity_per_religion.png")
plt.close()
...
plt.savefig("plots3/toxicity_per_gender.png")
plt.close()
...
plt.savefig("plots3/negative_words_wordcloud.png")
plt.close()
...
print("\n✅ Alle Plots wurden gespeichert im Ordner `plot3/`.")
