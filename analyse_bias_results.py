...
# CSV einlesen
df = pd.read_csv("persona_bias_optimized4.csv")
...
plt.ylabel("Anzahl")
plt.savefig("plots4/toxicity_distribution.png")
plt.close()
...
plt.ylabel("Anzahl")
plt.savefig("plots4/sentiment_per_topic.png")
plt.close()
...
plt.savefig("plots4/toxicity_per_religion.png")
plt.close()
...
plt.savefig("plots4/toxicity_per_gender.png")
plt.close()
...
plt.savefig("plots4/negative_words_wordcloud.png")
plt.close()
...
print("\n✅ Alle Plots wurden gespeichert im Ordner `plot4/`.")
