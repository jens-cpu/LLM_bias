...
# CSV einlesen
df = pd.read_csv("persona_bias_optimized2.csv")
...
plt.ylabel("Anzahl")
plt.savefig("plots/toxicity_distribution2.png")
plt.close()
...
plt.ylabel("Anzahl")
plt.savefig("plots/sentiment_per_topic2.png")
plt.close()
...
plt.savefig("plots/toxicity_per_religion2.png")
plt.close()
...
plt.savefig("plots/toxicity_per_gender2.png")
plt.close()
...
plt.savefig("plots/negative_words_wordcloud2.png")
plt.close()
...
print("\n✅ Alle Plots wurden gespeichert im Ordner `plots2/`.")
